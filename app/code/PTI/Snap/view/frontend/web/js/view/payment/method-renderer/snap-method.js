define(
    [
        ...
        'PTI_Snap/js/action/set-payment-method',
    ...
    function (Component, $, quote, urlBuilder, storage, errorProcessor, customer, fullScreenLoader, setPaymentMethodAction, additionalValidators, url, messageList) {
        ...
        return Component.extend({
            defaults: {
                template: 'PTI_Snap/payment/snap'
            },
                                    ...
                                    snap.pay(token, 
                                    {
                                        ...
                                        onClose: function(){
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(){
                                                    messageList.addErrorMessage({
                                                        message: 'customer closed the popup without finishing the payment, please reorder'
                                                    });
                                                    console.log('customer closed the popup without finishing the payment');
                                                    setTimeout(window.location.replace(url.build('checkout/onepage/failure')), 2000);
